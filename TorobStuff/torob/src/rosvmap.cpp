...
void RosVmap :: data_subscriber( const margent_msgs::Data& vmap ){
...
void RosVmap :: scan_subscriber( const sensor_msgs::LaserScan& scan, bool closed ){
 ...
 * Margent interface:
*/
void RosVmap :: toTorobData( const mia::Data & d, margent_msgs::Data * td ){
  td->mesage= "margent_msgs::Data";
...
void RosVmap :: toMargentData( const margent_msgs::Data & td, mia::Data * d ){
  
  d->initialize( "margent_msgs::Data", td.flag.size(), td.value.size() );
