...
public:
    ...
    void data_subscriber( const margent_msgs::Data& vmap );
    void vmap_subscriber( const torob_msgs::VectorMap& vmap );
    void scan_subscriber( const sensor_msgs::LaserScan& scan, bool closed= false );
    ...
    // Margent interface:
    void toTorobData( const mia::Data & d, margent_msgs::Data * td );
    void toMargentData( const margent_msgs::Data & td, mia::Data * d );
