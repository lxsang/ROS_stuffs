...
void Frame::drawVisiMap( const VisiMap & vm, const Float2 & delta, bool info )
{
    ...
    */
    ...
    Color cType[2][Node2::type_size]= {
        { Color(0x1010A0FF), Color(0xB01010FF), Color(0x10B010FF) }, // type_free, type_obstacle, type_frontier
        { Color(0x1010A080), Color(0xB0101080), Color(0x10B01080) } // type_free, type_obstacle, type_frontier
    };
