...
if("FALSE" STREQUAL "TRUE")
  set(map_merger_SOURCE_PREFIX /home/mrsang/torob_ws/src/map_merger)
  set(map_merger_DEVEL_PREFIX /home/mrsang/torob_ws/src/map_merger/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_merger' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Peter Kohout <peter_kohout@gmx.at>' to fix it.")
    endif()
